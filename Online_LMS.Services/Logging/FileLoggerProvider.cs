...
namespace NReco.Logging.File
{
    ...
    public class FileLoggerProvider : ILoggerProvider
    {
        ...
        public FileLoggerOptions Options { get; private set; }
        ...
        public class FileWriter
        {
            ...
            public FileWriter(FileLoggerProvider fileLogPrv)
            {
            ...
            void OpenFile(bool append)
            {
                ...
                void createLogFileStream()
                {
                    ...
                    LogFileStream = new FileStream(LogFileName, FileMode.OpenOrCreate, FileAccess.ReadWrite, FileShare.ReadWrite);
                    if (append)
                    {
            ...
            public void WriteMessage(string message, bool flush)
            {
        ...
        public class FileError
        {
            ...
            public FileError(string logFileName, Exception ex)
            {
